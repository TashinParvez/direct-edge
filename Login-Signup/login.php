    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 shadow-lg rounded-2xl p-8 bg-white w-[90%] max-w-5xl">
        ...
        <div class="flex justify-center items-center p-4">
            <svg xmlns="http://www.w3.org/2000/svg" width="500" height="400" viewBox="0 0 708 555.86743">
                ...
                <path id="a32c10c7-75df-4179-a648-6a8d2a687209-59" data-name="Path 134"
                ...
                <path
                    ...
                    transform="translate(-246 -172.06628)" fill="#3f3d56" />
                <path
                    ...
                    transform="translate(-246 -172.06628)" fill="#fff" />
                <path
                ...
                <path
                    ...
                    transform="translate(-246 -172.06628)" fill="#00bfa6" />
                <path
                ...
                <path
                    ...
                    transform="translate(-246 -172.06628)" fill="#00bfa6" />
                <circle cx="131.82814" cy="239.22404" r="51" fill="#00bfa6" />
                <path
                ...
                <path
                    ...
                    transform="translate(-246 -172.06628)" fill="#2f2e41" />
                <rect x="528.17702" y="440.81546" width="42.23651" height="42.23651"
                    transform="translate(147.61407 -410.75474) rotate(37.40978)" fill="#f0f0f0" />
                <path
                    ...
                    transform="translate(-246 -172.06628)" fill="#f0f0f0" />
                <path d="M953,727.93372H247a1,1,0,0,1,0-2H953a1,1,0,0,1,0,2Z" transform="translate(-246 -172.06628)"
                    fill="#3f3d56" />
                <path
