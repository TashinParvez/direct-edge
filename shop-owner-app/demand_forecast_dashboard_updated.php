<?php
// EMERGENCY AJAX TEST: Bypass all includes if AJAX request detected
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    // Skip all includes and go straight to AJAX handling
    include '../include/connect-db.php';
    $shop_id = isset($user_id) ? $user_id : 6;

    header('Content-Type: application/json');
    error_log("[EMERGENCY TEST] AJAX action={$_POST['action']} shop_id=" . ($_POST['shop_id'] ?? 'NONE'));
    ...
    if ($_POST['action'] === 'get_forecast_products') {
        ...
        error_log("[EMERGENCY TEST] Found " . count($products) . " products");
        ...
        <div class="controls-card">
            <div class="controls-grid">
                <div class="form-group">
                    <label>Shop</label>
                    <div style="padding: 10px; background: #f1f5f9; border-radius: 8px; font-weight: 500; color: #1f2a44;">
    ...
    <script>
        (function() {
            ...
            function loadProducts() {
                ...
                console.log('[LOAD PRODUCTS] shop_id=', shopId);
                ...
                fetch('', {
                    ...
                    .then(text => {
                        ...
                        try {
                            ...
                            productsGrid.innerHTML = `
                            <div class="empty-state" style="background: #fee; padding: 20px; white-space: pre-wrap; text-align: left; font-family: monospace; font-size: 12px;">
                                <h3>Error Loading Products - RAW RESPONSE:</h3>
                                <div style="max-height: 400px; overflow: auto; border: 1px solid #f00; padding: 10px; background: white;">${text.substring(0, 2000)}</div>
                            </div>
                        `;
                        }
                    })
            ...
            function createProductCard(product) {
                ...
                card.onclick = () => window.selectProduct(product);
            ...
            function loadExistingForecast() {
                ...
                fetch('', {
                    ...
                    .then(text => {
                        try {
                            const forecasts = JSON.parse(text);
                            ...
                            console.error('Failed to parse forecast JSON:', err);
            ...
            window.generateNewForecast = generateNewForecast;
