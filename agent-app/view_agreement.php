...
if (!$agreement) {
    header("Location: my_agreements.php");
    exit();
}
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6 no-print">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div class="flex gap-3">
                    ...
                    <a href="my_agreements.php" class="px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition">
        ...
        <div class="bg-white rounded-lg shadow-lg p-8 mb-6" id="agreement-content">
                    ...
                    <div class="text-center">
                        <div class="border-2 border-gray-300 rounded-lg p-4 mb-3 bg-white h-40 flex items-center justify-center">
                            <?php if ($agreement['agent_signature_url']): ?>
                                <img src="<?php echo htmlspecialchars($agreement['agent_signature_url']); ?>" alt="Agent Signature" class="max-h-32">
                            <?php else: ?>
                    ...
                    <div class="text-center">
                        <div class="border-2 border-gray-300 rounded-lg p-4 mb-3 bg-white h-40 flex items-center justify-center">
                            <?php if ($agreement['farmer_signature_url']): ?>
                                <img src="<?php echo htmlspecialchars($agreement['farmer_signature_url']); ?>" alt="Farmer Signature" class="max-h-32">
                            <?php else: ?>
                                <p class="text-gray-400">No signature available</p>
                            <?php endif; ?>
                        </div>
            ...
            <div class="border-t pt-6 mt-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600">
                    ...
                    <?php if ($agreement['terms_accepted_at']): ?>
                        <p><span class="font-semibold">Terms Accepted:</span> <?php echo date('F d, Y H:i', strtotime($agreement['terms_accepted_at'])); ?></p>
                    <?php endif; ?>
                </div>
            </div>
