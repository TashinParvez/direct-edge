...
<body class="bg-gray-100">
    ...
    <section class="home-section max-w-6xl mx-auto px-6 md:px-12 pb-4">
        ...
        <div
            class="mx-4 mb-4 <?php echo $message_type == 'success' ? 'bg-green-100 border border-green-400 text-green-700' : 'bg-red-100 border border-red-400 text-red-700'; ?> px-4 py-3 rounded">
            <div class="flex items-center">
                <i
                    class='bx <?php echo $message_type == 'success' ? 'bx-check-circle' : 'bx-error-circle'; ?> mr-2'></i>
                <?php echo $message; ?>
            </div>
            ...
            <div class="bg-white shadow-lg rounded-lg p-6 form-container">
                ...
                <div class="mb-6 text-center">
                    ...
                    <div class="mb-4">
                        ...
                        <img src="<?php echo htmlspecialchars($farmer['profile_picture']); ?>" alt="Current Profile"
                            class="w-24 h-24 rounded-full mx-auto object-cover border-2 border-green-200 profile-picture-preview">
                    </div>
                    <?php endif; ?>
                </div>

                <form action="edit-farmer.php?id=<?php echo $farmer_id; ?>" method="POST" enctype="multipart/form-data"
                    class="grid grid-cols-1 md:grid-cols-2 gap-6">

                    <!-- Hidden field to keep existing profile picture -->
                    <input type="hidden" name="existing_profile_picture"
                        value="<?php echo htmlspecialchars($farmer['profile_picture']); ?>">

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Full Name *</label>
                        <input type="text" name="full_name"
                            value="<?php echo htmlspecialchars($farmer['full_name']); ?>" placeholder="Enter full name"
                            required
                    ...
                    <div>
                        ...
                        <input type="text" name="nid_number"
                            value="<?php echo htmlspecialchars($farmer['nid_number']); ?>"
                    ...
                    <div>
                        ...
                        <input type="tel" name="contact_number"
                            value="<?php echo htmlspecialchars($farmer['contact_number']); ?>" placeholder="01XXXXXXXXX"
                            required
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 form-field">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="file" name="profile_picture" accept="image/*"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 form-field">
                        <p class="text-xs text-gray-500 mt-1">Leave empty to keep current picture. Maximum file size:
                            2MB (JPG, PNG, GIF)</p>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="farmer_type"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 form-field">
                            <option value="Small" <?php echo $farmer['farmer_type'] == 'Small' ? 'selected' : ''; ?>>
                                Small</option>
                            <option value="Medium" <?php echo $farmer['farmer_type'] == 'Medium' ? 'selected' : ''; ?>>
                                Medium</option>
                            <option value="Large" <?php echo $farmer['farmer_type'] == 'Large' ? 'selected' : ''; ?>>
                                Large</option>
                        </select>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="crops_cultivated"
                            value="<?php echo htmlspecialchars($farmer['crops_cultivated']); ?>"
                    ...
                    <div>
                        ...
                        <select name="land_ownership"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 form-field">
                            <option value="Own Land"
                                <?php echo $farmer['land_ownership'] == 'Own Land' ? 'selected' : ''; ?>>Own Land
                            </option>
                            <option value="Leased Land"
                                <?php echo $farmer['land_ownership'] == 'Leased Land' ? 'selected' : ''; ?>>Leased Land
                            </option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="bank_account"
                            value="<?php echo htmlspecialchars($farmer['bank_account']); ?>"
                            placeholder="Bank account number"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 form-field">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Mobile Banking Account
                            Number</label>
                        <input type="text" name="mobile_banking_account"
                            value="<?php echo htmlspecialchars($farmer['mobile_banking_account']); ?>"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="training_received"
                            value="<?php echo htmlspecialchars($farmer['training_received']); ?>"
                            placeholder="e.g., Agricultural Training"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 form-field">
                    </div>

                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Average Selling Price for a Specific
                            Crop</label>
                        <input type="text" name="avg_selling_price"
                            value="<?php echo htmlspecialchars($farmer['avg_selling_price']); ?>"
                    ...
                    <div class="md:col-span-2 flex justify-center space-x-3">
                        <button type="submit"
                            class="bg-green-500 text-white px-3 py-1.5 rounded text-sm hover:bg-green-600 transition-colors font-semibold">
