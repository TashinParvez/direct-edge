        ...
        <div class="container mx-auto px-4">
            ...
            <div class="bg-white shadow-lg rounded-lg p-6 mb-6 filter-container">
                <form method="GET" class="flex flex-col md:flex-row gap-4">
                    ...
                    <select name="area" class="px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 search-field">
                    ...
                    <select name="warehouse" class="px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 search-field">
                    ...
                    <select name="farmer_count" class="px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 search-field">
                ...
                <div class="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <div class="flex items-center">
                        ...
                        <span class="text-blue-800 font-medium">
                            <?php echo count($agents_filtered); ?> agent<?php echo count($agents_filtered) != 1 ? 's' : ''; ?> found
                            <?php if (!empty($search)): ?>for "<?php echo htmlspecialchars($search); ?>"<?php endif; ?>
                        </span>
                        <a href="all-agents.php" class="ml-4 text-blue-600 hover:text-blue-800 underline text-sm">Clear filters</a>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <?php if (count($agents_filtered) === 0): ?>
                <div class="bg-white shadow-xl rounded-lg p-16 text-center empty-state">
                    ...
                    <?php if (!empty($search) || !empty($area_filter) || !empty($warehouse_filter) || !empty($farmer_count_filter)): ?>
                        <a href="all-agents.php" class="inline-flex items-center bg-gray-500 text-white px-6 py-3 rounded-lg hover:bg-gray-600 transition-colors">
            ...
            <?php else: ?>
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 agents-grid">
                    <?php foreach ($agents_filtered as $agent): ?>
                        <a href="one-agent-info.php?id=<?= $agent['id'] ?>" class="bg-white rounded-xl shadow-md hover:shadow-xl overflow-hidden agent-card border border-gray-100">
