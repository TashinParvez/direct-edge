...
$sql = "SELECT 
            ...
            GROUP_CONCAT(DISTINCT c.name ORDER BY c.name SEPARATOR ', ') AS area,
...
<head>
    <meta charset="UTF-8">
    <title>Agent Info - <?= htmlspecialchars($agent['name'] ?? 'Unknown') ?> - Stock Integrated</title>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md mb-6 agent-profile-card">
                <div class="flex flex-col md:flex-row gap-6">
                    ...
                    <div class="flex-1">
                        <h2 class="text-2xl font-bold mb-4 text-gray-900"><?= htmlspecialchars($agent['name'] ?? 'Unknown Agent') ?></h2>
                        <div class="space-y-2">
                            <p class="text-gray-600 flex items-center">
                                <i class='bx bx-envelope mr-2 text-gray-400'></i>
                                Email: <?= htmlspecialchars($agent['email'] ?? 'N/A') ?>
                            </p>
                            <p class="text-gray-600 flex items-center">
                            ...
                            <p class="text-gray-600 flex items-center">
                                ...
                                Area: <?= htmlspecialchars($agent['area'] ?? 'N/A') ?>
                            </p>
                            <p class="text-gray-600 flex items-center">
                                <i class='bx bx-building mr-2 text-gray-400'></i>
                                Warehouse: <?= htmlspecialchars($agent['warehouse'] ?? 'N/A') ?>
                            </p>
                            <p class="text-gray-600 flex items-center">
            ...
            <div class="mb-8">
                ...
                <?php if (empty($warehouse_products)): ?>
                    <div class="bg-white shadow-md rounded-lg p-12 text-center">
                        ...
                        <p class="text-gray-500">This agent has not added any products to warehouses yet.</p>
                    </div>
                <?php else: ?>
            ...
            <div class="mb-8">
                ...
                <?php if (empty($farmers)): ?>
                    <div class="bg-white shadow-md rounded-lg p-12 text-center">
                        ...
                        <h4 class="text-xl font-semibold text-gray-600 mb-2">No Farmers Found</h4>
                        <p class="text-gray-500">This agent has not added any farmers yet.</p>
                    </div>
                <?php else: ?>
