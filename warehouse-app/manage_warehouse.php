...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['updateWarehouse'])) {
    ...
    $updateStmt = $conn->prepare("UPDATE warehouses SET name=?, location=?, capacity=? WHERE warehouse_id=?");
    $updateStmt->bind_param("ssii", $name, $location, $capacity, $warehouseId);
...
<body class="bg-gray-50 p-8">
    ...
    <div class="max-w-5xl mx-auto bg-white shadow rounded-lg p-6">
        <h1 class="text-3xl font-bold text-blue-700 mb-6">Manage Warehouse: <?= htmlspecialchars($warehouse['name']) ?></h1>
        ...
        <form method="POST" class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            ...
            <div class="mb-4">
                ...
                <select name="type" class="w-full border rounded p-2 mt-1 focus:ring focus:ring-blue-200">
            ...
            <div class="mb-4 col-span-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                <div>
                    ...
                    <select name="status" class="w-full border rounded p-2 mt-1 focus:ring focus:ring-blue-200">
            ...
            <div class="mb-4 col-span-full">
                ...
                <textarea name="location_full" class="w-full border rounded p-2 mt-1 focus:ring focus:ring-blue-200" rows="2"><?= htmlspecialchars($warehouse['location']) ?></textarea>
            </div>
            ...
            <table class="w-full border border-gray-200 rounded-lg overflow-hidden">
                <thead class="bg-gray-100 text-gray-700">
                    <tr>
                        ...
                        <th class="p-3 text-left">Edit</th> <!-- New column -->
                    </tr>
                </thead>
                        ...
                        <div class="flex">
                            ...
                            <div class="w-2/3 p-4">
                                ...
                                <form method="POST" action="update_product.php">
                                    ...
                                    <div class="mb-2">
                                        <label class="block text-sm font-medium text-gray-700">Warehouse Name</label>
                                        <input type="text" name="warehouse_name" value="<?= htmlspecialchars($row['warehouse_name']) ?>" class="w-full border rounded p-2 mt-1 focus:ring focus:ring-blue-200">
                                    </div>

                                    <div class="mb-2">
                                        <label class="block text-sm font-medium text-gray-700">Location</label>
                                        <input type="text" name="warehouse_location" value="<?= htmlspecialchars($row['warehouse_location']) ?>" class="w-full border rounded p-2 mt-1 focus:ring focus:ring-blue-200">
                                    </div>
