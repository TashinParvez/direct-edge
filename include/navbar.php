                ...
                <div class="flex-1 flex justify-center">
                    <ul class="flex space-x-6 items-center">
                        <?php if ($role === 'Admin'): ?>
                            ...
                            <li>
                                <a href="/../warehouse-app/admin-dashboard/admin-dashboard.php"
                                    class="font-semibold <?php echo ($current_page == 'admin-dashboard.php') ? 'text-green-700' : 'text-gray-700 hover:text-green-700'; ?>">
                                    Dashboard
                                </a>
                            </li>
                            <li>
                                <a href="/../warehouse-app/warehouse information/product-list.php"
                                    class="font-semibold <?php echo ($current_page == 'product-list.php') ? 'text-green-700' : 'text-gray-700 hover:text-green-700'; ?>">
                                    Products
                                </a>
                            </li>
                            <li>
                            ...
                            <li class="relative" x-data="{ open: false }" @mouseenter="open = true"
                                ...
                                <div x-show="open" x-transition
                                    ...
                                    <a href="/../warehouse-app/agent/all-agents.php"
                                        class="block px-8 py-3 font-semibold <?php echo ($current_page == 'all-agents.php') ? 'text-green-700 bg-green-50' : 'text-gray-700 hover:bg-green-50 hover:text-green-700'; ?>">
                                        All Agents
                                    </a>
                        ...
                        <?php elseif ($role === 'Shop-Owner'): ?>
                            <!-- SHOP OWNER NAV -->
                            <li><a href="/../shop-owner-app\Profuct-for-buyers-from-shop\Available-Products-List.php"
                                    class="font-semibold <?php echo ($current_page == 'home.php') ? 'text-green-700' : 'text-gray-700 hover:text-green-700'; ?>">Home</a></li>
                            <li><a href="/../shop-owner-app\buy-products-from-warehouse.php"
                                    class="font-semibold <?php echo ($current_page == 'buy-products.php') ? 'text-green-700' : 'text-gray-700 hover:text-green-700'; ?>">
                                    Buy Products</a></li>
                            <li><a href="/../shop-owner-app\Self-Service-Orders\Self-Service-Orders.php"
                            ...
                            <li><a href="/../shop-owner-app\DemandForecast\demand_forecast_dashboard_updated.php"
                        ...
                        <?php else: ?>
                            ...
                            <li><a href="../User/update-profile.php"
                                    class="font-semibold <?php echo ($current_page == 'update-profile.php') ? 'text-green-700' : 'text-gray-700 hover:text-green-700'; ?>">Update
                                    Profile</a></li>
